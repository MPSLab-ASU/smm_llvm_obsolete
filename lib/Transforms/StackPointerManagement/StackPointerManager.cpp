...
namespace
{
    struct StackPointerManagerPass : public ModulePass
    {
        static char ID; // Pass identification, replacement for typeid
        StackPointerManagerPass() : ModulePass(ID) {}
...
char StackPointerManagerPass::ID = 0; //Id the pass.
static RegisterPass<StackPointerManagerPass> X("stk-ptr-mgmt", "Stack Pointer Management Pass"); //Register the pass.